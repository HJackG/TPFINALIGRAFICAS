...
import org.example.model.entity.Messages;
import org.example.exception.MisExcepciones;
import org.example.model.repository.AdminRepository;
import org.example.model.repository.ClienteRepository;
import org.example.model.repository.implementations.Controller;
...
public class AdminController implements Controller<Admin> {
    ...
    public boolean terminateBook(Integer id)
    {
        return bookController.terminateBook(id);
    }


    public Book searchLibro(Integer id, boolean flag) {
        return bookController.searchBookId(id);
