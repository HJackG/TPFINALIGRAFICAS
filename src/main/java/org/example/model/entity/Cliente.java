...
private boolean userActive;
    ...
    public String toString() {
        ...
        sb.append("\n")
                .append(super.toString()) // Llama al toString de la superclase si es necesario
                .append("\n")
                .append("  Libros actualmente prestados: ").append(currentlyBorrowedBook).append("\n")
                .append("  Historial de devoluciones: ").append(returnHistory).append("\n")
                .append("  Libros favoritos: ").append(listFavBook).append("\n");
        return sb.toString();
    }
